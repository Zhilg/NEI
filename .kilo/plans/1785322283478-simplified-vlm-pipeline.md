...
5. **Размер моделей** — на RTX 5070 (8 GB VRAM) текущие Qwen2.5-VL-32B и Qwen3-14B не влезают. Требуются дистиллированные или обрезанные версии (например, контекст до 50k токенов, quantized AWQ/GGUF). На Windows для e2e-тестирования нужны ещё более лёгкие модели.
